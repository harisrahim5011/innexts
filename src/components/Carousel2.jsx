export default function Carousel() {
  return (
    <div className="h-[30rem] items-center justify-center hidden md:flex">
      <div className="mx-auto max-w-6xl px-6">
        <div className="flex  [&:hover>div]:w-16 [&>div:hover]:w-[30rem] [&>div]:rounded-lg gap-1 ">
          ...
          <div className="group relative h-96 w-16 cursor-pointer overflow-hidden shadow-lg shadow-black/30 transition-all duration-200">
            <img
              ...
              alt=""
            />
            <div className="invisible absolute inset-0 bg-gradient-to-b from-green-500/20 to-black group-hover:visible -z-[1]">
              <div className="absolute inset-x-5 bottom-6">
                <div className="flex gap-3 text-white">
                <button>View Services</button>
                  {/* <svg width={48} height={48} viewBox="0 0 24 24">
